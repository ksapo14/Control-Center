            ...
            <div className="grid grid-cols-[1fr_auto_1fr] items-center">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <TactileButton
                  ...
                  data-shortcut-id="spotify:toggle"
                  ...
                  data-control-action="spotify-toggle"
                ...
                <button type="button" aria-label="Next Spotify track" data-shortcut-combo="Control+Alt+KeyL" data-shortcut-id="spotify:next" data-shortcut-label="Next Spotify track" data-shortcut-detail="Transport forward" data-shortcut-group="Spotify" data-shortcut-order="2" onClick={() => void controlPlayback("next")} disabled={controlBusy} className="deck-button spotify-transport-button disabled:cursor-wait disabled:opacity-40">
